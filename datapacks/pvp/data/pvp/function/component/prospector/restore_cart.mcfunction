...
item replace entity @s hotbar.8 with minecart[item_name='{"color":"#E5C221","text":"Minecart"}',consumable={consume_seconds:1000000,sound:"entity.turtle.shamble_baby",has_consume_particles:false},custom_data={component:"prospector",category:"armor"}]
