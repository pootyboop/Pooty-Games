execute if entity @n[type=marker,tag=currconductor,tag=c_fire] run function pvp:e/conductorground/fire/apply
...
execute if entity @n[type=marker,tag=currconductor,tag=c_explosion] if predicate pvp:hurt/not_hurt run function pvp:e/conductorground/explosion/explode