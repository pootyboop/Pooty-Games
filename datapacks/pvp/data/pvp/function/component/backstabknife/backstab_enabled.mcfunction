execute as @n[type=#pvp:fighter,tag=fighter,tag=backstabbee] at @s positioned ~ ~1.1 ~ run particle dust{color:[0.459,0.000,0.000],scale:2} ~ ~ ~ .1 0 .1 0 2 force @p[tag=backstabber]
