...
execute as @p[gamemode=!spectator,distance=..6,scores={goldCt=3..}] at @s run function bitem:pick3_2
execute unless entity @p[gamemode=!spectator,distance=..6,scores={goldCt=3..}] run function bitem:reject


clear @p[gamemode=!spectator] iron_pickaxe[custom_data~{bmenu1:1b}]
