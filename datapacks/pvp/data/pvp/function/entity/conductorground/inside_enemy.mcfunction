...
execute if entity @n[type=marker,tag=currconductor,tag=c_fire] run function pvp:player/fire/setonfire
...
execute if entity @n[type=marker,tag=currconductor,tag=c_explosion] if entity @s[nbt={HurtTime:0s}] run function pvp:entity/conductorground/explosion/explode