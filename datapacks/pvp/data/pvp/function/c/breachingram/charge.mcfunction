...
function pvp:c/breachingram/charge_fx with storage pvp:storage temp

execute if score @s breachingram.timer >= breachingram.chargetime weaponStats positioned ~ ~1.35 ~ positioned ^ ^ ^2 if block ~ ~ ~ #minecraft:air at @s run function pvp:c/breachingram/ram/start