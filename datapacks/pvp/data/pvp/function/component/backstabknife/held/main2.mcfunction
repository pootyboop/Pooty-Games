execute if entity @n[predicate=pvp:fighter,distance=.1..4] as @e[predicate=pvp:fighter,distance=..4] at @s run function pvp:component/backstabknife/backstab_check
