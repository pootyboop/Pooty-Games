...
item replace entity @s hotbar.8 with beacon[item_name='{"color":"#3990a5","text":"👁 VISIBLE 👁"}',consumable={consume_seconds:1000000,sound:"entity.turtle.shamble_baby",has_consume_particles:false},custom_data={component:"insight",category:"armor"}]
