...
execute if score @s breachingram.timer matches 22.. positioned ~ ~1.35 ~ positioned ^ ^ ^2 if block ~ ~ ~ #minecraft:air at @s run function pvp:component/breachingram/ram/start