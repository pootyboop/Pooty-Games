...
execute as @e[type=block_display,tag=newfakeblock] run function pvp:entity/platform/spawn_fakeblock
execute as @e[type=shulker,tag=newfakeblock] run function pvp:entity/platform/spawn_fakeblock
