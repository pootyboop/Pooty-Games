...
execute unless score ray dummy matches 20.. if block ~ ~ ~ #minecraft:air positioned ~ ~-1.35 ~ unless entity @n[type=#pvp:fighter,distance=..0.75,tag=fighter,tag=backstabbee] positioned ^ ^ ^.2 positioned ~ ~1.35 ~ run return run function pvp:component/backstabknife/raycast
