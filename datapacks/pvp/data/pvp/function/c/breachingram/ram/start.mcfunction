...
execute positioned 0.0 0.0 0.0 run function pvp:c/breachingram/ram/start_motion with storage pvp:storage temp
...
function pvp:c/breachingram/ram/start_summon with storage pvp:storage temp
