...
function pvp:loadout/button {"slot":"14","id":"6","type":"read","block":"purple","color":"#7f00ff"}
function pvp:loadout/button {"slot":"15","id":"7","type":"read","block":"magenta","color":"#ff4ff6"}
