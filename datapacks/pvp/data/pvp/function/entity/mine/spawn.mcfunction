...
summon slime ~ ~ ~ {Silent:1b,PersistenceRequired:1b,NoAI:1b,Health:1000f,Size:1,Rotation:[0F,0F],Tags:["newmine","mine","trap"],active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:max_health",base:1000},{id:"minecraft:scale",base:0.8}]}
