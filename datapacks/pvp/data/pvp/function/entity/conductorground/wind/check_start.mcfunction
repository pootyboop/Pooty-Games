...
execute if entity @n[type=wind_charge,tag=!fakeexplosionwindcharge,distance=..4.5] run return run function pvp:entity/conductorground/wind/start with storage pvp:storage temp