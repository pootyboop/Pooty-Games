...
function pvp:c/trifecta/get

function pvp:c/trifecta/transform/stage3_sword
function pvp:c/trifecta/transform/stage3_axe
function pvp:c/trifecta/transform/stage3_spear
