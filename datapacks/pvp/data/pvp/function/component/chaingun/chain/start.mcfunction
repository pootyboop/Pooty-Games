...
execute as @n[predicate=pvp:fighter,tag=chaining,tag=chain1] at @s positioned ~ ~1.3 ~ positioned ^-.5 ^ ^.4 facing entity @n[tag=chain2] eyes run function pvp:component/chaingun/chain/start2
