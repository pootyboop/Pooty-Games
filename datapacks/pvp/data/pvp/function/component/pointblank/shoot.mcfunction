...
execute as @e[type=arrow,distance=..3,tag=!pointblank,nbt={weapon:{components:{"minecraft:custom_data":{component:"pointblank"}}}}] at @s run function pvp:component/pointblank/shoot2