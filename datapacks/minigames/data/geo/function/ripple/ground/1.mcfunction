...
execute as @a at @n[type=area_effect_cloud,tag=ripple] if score @s uuid0 = @n[type=area_effect_cloud,tag=ripple] uuid0 run function geo:ripple/shot

execute as @a[distance=..3] run function geo:ripple/hit
execute as @e[distance=..3,type=falling_block] run function geo:ripple/hit
execute as @e[distance=..3,type=armor_stand] run function geo:ripple/hit
execute as @e[distance=..3,type=villager] run function geo:ripple/hit
...
schedule function geo:ripple/ground/check 1
