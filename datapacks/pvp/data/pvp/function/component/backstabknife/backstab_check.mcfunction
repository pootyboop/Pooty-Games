...
execute if entity @s[tag=backstabbee] run scoreboard players operation @s backstabknife.rotation -= @n[type=#pvp:fighter,tag=fighter,tag=backstabber] backstabknife.rotation
execute if score @s backstabknife.rotation matches ..0 run scoreboard players operation @s backstabknife.rotation *= -1 num
