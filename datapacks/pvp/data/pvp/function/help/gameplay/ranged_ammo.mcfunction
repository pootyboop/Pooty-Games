...
function pvp:misc/spawnstuff/info/chat/empty
function pvp:misc/spawnstuff/info/chat/simple {"message":"Ranged weapons that plant traps work differently. These weapons can't be reloaded, and only regain ammo once the trap is tripped/destroyed (or if you miss your shot)."}
function pvp:misc/spawnstuff/info/chat/empty
