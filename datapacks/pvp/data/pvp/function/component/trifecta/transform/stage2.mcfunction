...
execute unless score @s trifecta.mode matches 2 run return run function pvp:component/trifecta/transform/hoe
function pvp:component/trifecta/transform/pick