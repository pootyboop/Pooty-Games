...
execute if entity @s[team=Red] run scoreboard players set @e[limit=1,type=area_effect_cloud,tag=redGen] uForge 1
execute if entity @s[team=Yellow] run scoreboard players set @e[limit=1,type=area_effect_cloud,tag=yellowGen] uForge 1
execute if entity @s[team=Blue] run scoreboard players set @e[limit=1,type=area_effect_cloud,tag=blueGen] uForge 1
execute if entity @s[team=Green] run scoreboard players set @e[limit=1,type=area_effect_cloud,tag=greenGen] uForge 1
