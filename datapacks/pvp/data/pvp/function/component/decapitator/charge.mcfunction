...
execute if score @s decapitator.chargelevel matches 1 run function pvp:component/decapitator/charge_lv1
execute if score @s decapitator.chargelevel matches 2 run function pvp:component/decapitator/charge_lv2
execute if score @s decapitator.chargelevel matches 3 run function pvp:component/decapitator/charge_lv3