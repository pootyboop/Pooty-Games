...
execute if items entity @n[predicate=pvp:fighter,tag=glaciermain] armor.head *[minecraft:custom_data~{component:"mercenary"}] run scoreboard players add @s glacier.timer 6

execute if score @s glacier.timer matches 300.. at @s run function pvp:c/glacier/icewall/block/ready
...
function pvp:c/glacier/icewall/block/main2 with storage pvp:storage temp