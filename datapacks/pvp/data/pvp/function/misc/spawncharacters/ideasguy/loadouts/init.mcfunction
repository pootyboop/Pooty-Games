...
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":2,"category":"item","component":"dynamite"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":2,"category":"item2","component":"dynamite"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":2,"category":"item3","component":"fireball"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":3,"message":"The ultimate jack-of-all-trades loadout! You've got tools for every situation."}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":3,"category":"armor","component":"wright"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":3,"category":"weapon","component":"trifecta"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":3,"category":"weapon2","component":"blightbow"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":3,"category":"weapon3","component":"bulwark"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":3,"category":"item","component":"windcharge"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":4,"message":"This one lets you whittle enemies down with every status in the book!"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":4,"category":"armor","component":"hoarder"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":4,"category":"weapon","component":"blightbow"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":4,"category":"weapon2","component":"stunfork"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":4,"category":"item","component":"conductor"}
...
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":5,"category":"item","component":"enderpearl"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":5,"category":"item2","component":"ammopack"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":6,"message":"Set everything on fire and outrun incoming attacks. Just don't get hit!"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":6,"category":"armor","component":"hothead"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":6,"category":"weapon","component":"burnbow"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":6,"category":"weapon2","component":"vaulter"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":6,"category":"item","component":"rewind"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":6,"category":"item2","component":"sugar"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":7,"message":"Here's a good mix of mobility and offense. Control the field with wide-spreading weaponry while keeping enemies at a comfortable distance!"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":7,"category":"armor","component":"geokinetic"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":7,"category":"weapon","component":"breachingram"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":7,"category":"weapon2","component":"ridge"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":7,"category":"item","component":"platform"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":7,"category":"item2","component":"dynamite"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":8,"message":"Try this melee-focused build! You'll be healing left and right while wearing down enemies' max health."}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":8,"category":"armor","component":"slimey"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":8,"category":"weapon","component":"rotaxe"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":8,"category":"weapon2","component":"divinearc"}
...
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":11,"category":"item","component":"sugar"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":11,"category":"item2","component":"windcharge"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":12,"message":"Try this loadout for top-class close-quarters combat. Give the Dynamite + Conductor combo a try when someone's nearby!"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":12,"category":"armor","component":"permafrost"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":12,"category":"weapon","component":"bulwark"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":12,"category":"weapon2","component":"twinscythes"}
...
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":13,"category":"item","component":"windcharge"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":13,"category":"item2","component":"enderpearl"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":14,"message":"A classic combo. Vault above your enemies and drop down with a Point Blank shot to the face!"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":14,"category":"armor","component":"slimey"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":14,"category":"weapon","component":"vaulter"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":14,"category":"weapon2","component":"pointblank"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":14,"category":"item","component":"sugar"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":14,"category":"item2","component":"ammopack"}

function pvp:misc/spawncharacters/ideasguy/loadouts/init_message {"id":15,"message":"Mow down the competition with Machine Bowgun! And for when that doesn't work, you've got all kinds of options to get back on your feet."}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":15,"category":"armor","component":"evolving"}
function pvp:misc/spawncharacters/ideasguy/loadouts/init_component {"id":15,"category":"weapon","component":"machinebowgun"}
