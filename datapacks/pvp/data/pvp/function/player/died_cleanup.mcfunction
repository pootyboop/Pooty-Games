...
function pvp:player/died_cleanup_entity {"entity":"ender_pearl"}
function pvp:player/died_cleanup_entity {"entity":"block_display"}
function pvp:player/died_cleanup_entity {"entity":"shulker"}
function pvp:player/died_cleanup_entity {"entity":"trident"}
