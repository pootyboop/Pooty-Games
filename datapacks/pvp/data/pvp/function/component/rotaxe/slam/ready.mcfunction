...
execute anchored eyes positioned ^ ^ ^1 run particle scrape ~ ~ ~ .25 .25 .25 0 2 force @s
execute anchored eyes positioned ^ ^ ^1 run particle enchanted_hit ~ ~ ~ .25 .25 .25 0 2 force @s
