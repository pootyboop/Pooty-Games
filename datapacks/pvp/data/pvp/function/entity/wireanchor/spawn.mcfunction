...
execute as @n[predicate=pvp:fighter,tag=owner] run function pvp:component/salvo/explode
...
execute as @e[type=#pvp:plantedentity,tag=newwireanchor,tag=wireanchor,distance=..2] at @s run function pvp:entity/wireanchor/spawn2
