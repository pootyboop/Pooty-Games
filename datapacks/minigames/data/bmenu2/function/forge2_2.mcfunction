...
execute if entity @s[team=Red] run scoreboard players set @n[type=area_effect_cloud,tag=redGen] uForge 2
execute if entity @s[team=Yellow] run scoreboard players set @n[type=area_effect_cloud,tag=yellowGen] uForge 2
execute if entity @s[team=Blue] run scoreboard players set @n[type=area_effect_cloud,tag=blueGen] uForge 2
execute if entity @s[team=Green] run scoreboard players set @n[type=area_effect_cloud,tag=greenGen] uForge 2
