...
execute if score @s phlogiston.timer >= phlogiston.chargetime weaponStats unless score @s phlogiston.circle matches 0.. run function pvp:component/phlogiston/spin/start