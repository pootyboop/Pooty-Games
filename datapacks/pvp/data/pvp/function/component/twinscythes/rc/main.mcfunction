...
tag @s add rushcurr
function pvp:component/twinscythes/rc/main_call_marker
execute if items entity @s armor.head *[minecraft:custom_data~{component:"mercenary"}] run function pvp:component/twinscythes/rc/main_call_marker
