...
#execute as @n[type=falling_block,tag=flingblock] at @s run function geo:fling/blockpos
...
#execute as @n[type=falling_block,tag=flingblock] at @s run function geo:fling/motion