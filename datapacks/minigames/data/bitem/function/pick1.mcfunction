...
execute as @p[gamemode=!spectator,distance=..6,scores={ironCt=10..}] at @s run function bitem:pick1_2
execute unless entity @p[gamemode=!spectator,distance=..6,scores={ironCt=10..}] run function bitem:reject


clear @p[gamemode=!spectator] wooden_pickaxe[custom_data~{bmenu1:1b}]
