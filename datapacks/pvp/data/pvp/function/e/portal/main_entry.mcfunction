...
execute positioned ~ ~1 ~ as @e[type=#pvp:portalable,distance=0.1..1.2] if function pvp:e/movable_by_other_entities run function pvp:e/portal/entity_inside/start with storage pvp:storage temp
