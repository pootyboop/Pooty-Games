...
execute if score @s whistler.chargelevel matches 3 run function pvp:component/shared/backstep/start_at_strength {"strength":"1000000"}
execute if score @s whistler.chargelevel matches 4 run function pvp:component/shared/backstep/start
execute if score @s whistler.chargelevel matches 5 run function pvp:component/shared/backstep/start_at_strength {"strength":"1800000"}