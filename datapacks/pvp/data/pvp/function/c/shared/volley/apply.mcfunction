...
execute if items entity @s weapon.mainhand #pvp:bows positioned -10100 58 -10000 run function pvp:c/shared/volley/apply2
$function pvp:c/$(component)/volley/loaded