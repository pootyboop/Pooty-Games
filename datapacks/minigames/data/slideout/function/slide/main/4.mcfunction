...
execute unless block ~ ~ ~ #air run function slideout:slide/stop
...
execute positioned ^.35 ^ ^0.6 run function slideout:slide/particle
execute positioned ^-.35 ^ ^0.6 run function slideout:slide/particle
execute positioned ^ ^ ^0.75 run function slideout:slide/particle