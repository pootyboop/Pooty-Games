...
execute if score dummy dummy matches 1 if score @s dummy matches 1 unless items entity @s armor.head *[minecraft:custom_data~{component:"zealot"}] run data modify storage pvp:storage temp.categorywrite set value "weapon2"
...
execute if score dummy dummy matches 1 if score @s dummy matches 3 unless items entity @s armor.head *[minecraft:custom_data~{component:"wright"}] unless items entity @s armor.head *[minecraft:custom_data~{component:"zealot"}] run data modify storage pvp:storage temp.categorywrite set value "item2"
