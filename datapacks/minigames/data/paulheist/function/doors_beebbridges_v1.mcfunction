execute positioned 617 95 -328 run fill ~1 ~ ~2 ~-1 ~ ~-2 minecraft:red_stained_glass
execute positioned 622 95 -323 run fill ~2 ~ ~1 ~-2 ~ ~-1 minecraft:red_stained_glass
execute positioned 617 95 -318 run fill ~1 ~ ~2 ~-1 ~ ~-2 minecraft:air
execute positioned 612 95 -323 run fill ~2 ~ ~1 ~-2 ~ ~-1 minecraft:air

execute positioned 617 96 -323 run particle minecraft:large_smoke ~ ~ ~ 4 0 4 0 100

title @a actionbar [{"text":"Bridges Toggled: "},{"text":"v1","color":"aqua"}]
