...
execute unless entity @s[tag=noammowaiting] run function pvp:e/mine/kill_ammowaiting

execute at @e[type=slime,tag=mine,distance=..3] if score @s uuid0 = @n[type=slime,tag=mine] uuid0 as @n[type=slime,tag=mine] run function pvp:e/mine/kill_slime
