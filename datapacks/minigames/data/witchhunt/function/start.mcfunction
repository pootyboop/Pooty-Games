...
item replace entity @a[tag=hunter] hotbar.0 with trident[unbreakable={show_in_tooltip:0b},custom_name='{"text":"Witchfork","color":"dark_aqua","italic":false}',attribute_modifiers={modifiers:[{type:"generic.attack_damage",id:"generic.attack_damage",amount:1,operation:"add_value"}],show_in_tooltip:0b}]
