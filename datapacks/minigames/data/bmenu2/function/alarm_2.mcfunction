...
execute if entity @s[team=Red] run tag @e[limit=1,type=area_effect_cloud,tag=baseRed] add alarm
execute if entity @s[team=Yellow] run tag @e[limit=1,type=area_effect_cloud,tag=baseYellow] add alarm
execute if entity @s[team=Blue] run tag @e[limit=1,type=area_effect_cloud,tag=baseBlue] add alarm
execute if entity @s[team=Green] run tag @e[limit=1,type=area_effect_cloud,tag=baseGreen] add alarm
