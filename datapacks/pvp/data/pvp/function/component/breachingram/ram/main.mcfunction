...
execute as @e[type=#pvp:fighter,tag=fighter,distance=.1..2,nbt={HurtTime:0s}] run function pvp:component/breachingram/ram/damage
...
function pvp:component/breachingram/ram/stop_hit