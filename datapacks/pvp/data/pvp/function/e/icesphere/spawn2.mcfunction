...
execute positioned ~2 ~ ~ run function pvp:e/icesphere/sides/x
execute positioned ~-2 ~ ~ run function pvp:e/icesphere/sides/x
execute positioned ~ ~2 ~ run function pvp:e/icesphere/sides/y
execute positioned ~ ~-2 ~ run function pvp:e/icesphere/sides/y
execute positioned ~ ~ ~2 run function pvp:e/icesphere/sides/z
execute positioned ~ ~ ~-2 run function pvp:e/icesphere/sides/z

execute as @e[type=#pvp:fakeblock,tag=newfakeblock] run function pvp:e/icesphere/spawn_fakeblocks

execute as @e[predicate=pvp:fighter,distance=..1.75,tag=!owner] run function pvp:e/icesphere/dmg
