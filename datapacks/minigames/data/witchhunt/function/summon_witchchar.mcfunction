...
execute if entity @s[tag=!dmgd] run summon villager ~ ~ ~ {Health:300f,NoAI:1b,CanPickUpLoot:0b,Tags:["witchchar","newspawn"],Attributes:[{Name:max_health,Base:300}]}
execute if entity @s[tag=dmgd] run summon witch ~ ~ ~ {Health:300f,NoAI:1b,CanPickUpLoot:0b,Tags:["witchchar","newspawn"],Attributes:[{Name:max_health,Base:300}]}
