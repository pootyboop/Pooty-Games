...
execute store result score dummy dummy run attribute @s minecraft:generic.scale base get 100
...
data modify storage pvp:storage temp.attribute set value "minecraft:generic.step_height"
