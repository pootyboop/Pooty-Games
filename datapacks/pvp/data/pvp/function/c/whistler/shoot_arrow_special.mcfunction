...
$function pvp:c/whistler/shoot_motion {"axis":"x","id":"0","speed":"$(speed)"}
$function pvp:c/whistler/shoot_motion {"axis":"y","id":"1","speed":"$(speed)"}
$function pvp:c/whistler/shoot_motion {"axis":"z","id":"2","speed":"$(speed)"}
