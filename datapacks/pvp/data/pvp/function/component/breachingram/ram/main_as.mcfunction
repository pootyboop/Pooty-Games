...
execute at @s positioned ~ ~1.5 ~ positioned ^ ^ ^2 if entity @n[type=block_display,tag=fakeblock,distance=..1.5] as @p[tag=ramming] at @s run return run function pvp:component/breachingram/ram/stop
