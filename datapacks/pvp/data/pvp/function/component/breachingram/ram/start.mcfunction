...
execute store result score @s breachingram.yaw run data get entity @s Rotation[0] 100
execute store result score @s breachingram.pitch run data get entity @s Rotation[2] 100
