...
function pvp:loadout/button {"slot":"23","id":"6","type":"write","block":"purple","color":"#7f00ff"}
function pvp:loadout/button {"slot":"24","id":"7","type":"write","block":"magenta","color":"#ff4ff6"}