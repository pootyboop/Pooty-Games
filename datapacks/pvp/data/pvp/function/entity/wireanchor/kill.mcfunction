...
execute at @e[type=#pvp:wireanchor,tag=wireanchor,distance=..2.5] if score @s uuid0 = @n[type=#pvp:wireanchor,tag=wireanchor] uuid0 run kill @n[type=#pvp:wireanchor,tag=wireanchor]