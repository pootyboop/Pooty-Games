...
execute if score @s hideseekblockID matches 7 run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:oak_log"},NoGravity:1b,Time:110,DropItem:0b,HurtEntities:0b,Tags:["newhiderblock"]}
execute if score @s hideseekblockID matches 8 run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:smithing_table"},NoGravity:1b,Time:110,DropItem:0b,HurtEntities:0b,Tags:["newhiderblock"]}
...
execute if score @s hideseekblockID matches 101 run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:blast_furnace"},NoGravity:1b,Time:110,DropItem:0b,HurtEntities:0b,Tags:["newhiderblock"]}
execute if score @s hideseekblockID matches 102 run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:cauldron"},NoGravity:1b,Time:110,DropItem:0b,HurtEntities:0b,Tags:["newhiderblock"]}
