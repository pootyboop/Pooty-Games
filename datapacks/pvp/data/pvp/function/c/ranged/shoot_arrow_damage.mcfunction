...
execute if items entity @n[predicate=pvp:fighter,tag=currshooter] armor.head *[custom_data~{component:zealot}] run scoreboard players add .projectiledmg dummy 150
