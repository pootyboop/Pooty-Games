...
#execute as @n[predicate=pvp:fighter,tag=owner] positioned -10000 45 -10000 run function minecraft:insert_player_head
#data modify entity @s ArmorItems[3] set from block -10000 45 -10000 Items[0]
